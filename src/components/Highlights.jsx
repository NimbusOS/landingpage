            ...
            <div className="grid grid-cols-3 gap-10 mx-20">
                <div className="card bg-base-100 shadow-2xl shadow-secondary">
                    ...
                    <div className="card-body items-center text-center">
                        ...
                        <p className="text-sm text-base-300 ">You can view performance and usage data to identify and resolve any issues quickly. Plus, track your spending on Lambda functions to ensure you're not overspending on your serverless infrastructure</p>
                    </div>
                </div>
