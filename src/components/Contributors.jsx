...
const Contributors = () =>  {
    ...
    return (
        <div id="Contributors" className="pt-16">
            <h3 className="text-3xl text-center pb-10 text-bold text-base-300"> Meet The Team </h3>
            <div ref={ref} className={`${inView ? 'translate-y-0 duration-500' : 'translate-y-96'} flex flex-row justify-evenly flex-wrap`}>
                {cards}
            </div>
        </div>
    );
