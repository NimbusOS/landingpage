        ...
        <div id="Hero" className="hero min-h-screen pt-16 bg-base-100 relative z-0">
            <div className="hero-content flex-col lg:flex-row justify-start w-full">
                <div className="flex flex-col w-1/2">
                    <h3 className="text-base-300 text-3xl font-extrabold mx-4 mb-1">Go Serverless with Confidence.</h3>
                ...
                <div className="w-1/2 relative">
                    <div className="absolute rounded-xl shadow-xl bg-secondary flex justify-center items-center w-4/6 p-3 -top-40">
                        <img className="aspect-auto rounded-xl shadow-xl" alt="home page demo display on home tab" src={homeDisplayHome}/>
                    </div>
                    <div className="absolute rounded-xl shadow-xl bg-accent flex justify-center items-center w-3/6 p-3 top-50 left-80">
